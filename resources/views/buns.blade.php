...
<body>
    ...
    <div class="container my-5">
        <h1 class="text-center mb-4">Buns</h1>
            ...
            @foreach ($buns as $bun)
                <div class="col-md-4">
                    <div class="card shadow-sm">
                        ...
                        <img src="{{ asset('storage/' . $bun->image) }}" class="card-img-top" alt="{{ $bun->name }}">
                        <div class="card-body text-center">
                            ...
                            <form action="{{ route('cart.add') }}" method="POST" class="mt-3">
                                @csrf
                                <input type="hidden" name="name" value="{{ $bun->name }}">
                                <input type="hidden" name="price" value="{{ $bun->price }}">
                                <input type="hidden" name="image" value="{{ $bun->image }}">
                                ...
                                <button type="submit" class="btn btn-primary w-100 mt-3">Order Now</button>
                            </form>
                        </div>
                    </div>
                </div>
